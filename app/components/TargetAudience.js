            ...
            <section id="target-audience" className="grid grid-cols-1 gap-8 h-screen mx-8 max-md:h-[120dvh]">
                ...
                {typeAudience.map((type) => (
                    <div key={type.id} className="flex flex-col items-center">
                        <div className="shadow-[0_0_50px] shadow-gray-700 flex flex-col text-center gap-8 p-8 w-400 h-50 rounded-2xl bg-black transition-all duration-700 hover:scale-104 max-md:w-100 max-md:h-80">
